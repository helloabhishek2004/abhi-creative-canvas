      ...
      <div className="flex-1 overflow-y-auto no-scrollbar">
        <div className="grid grid-cols-3 gap-3 mt-2">
          {tools.map((tool) => (
            <div
              key={tool.name}
              className={`flex flex-col items-center justify-center p-3 rounded-xl transition-all duration-300 ${hoveredTool === tool.name
            ...
            >
              <div
                className={`p-2 rounded-full ${hoveredTool === tool.name
                  ? "animate-pulse"
