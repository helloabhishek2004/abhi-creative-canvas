...
const AboutMeModal = ({ isOpen, onClose }: AboutMeModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="no-scrollbar sm:max-w-[700px] max-h-[80vh] overflow-y-auto bg-secondary-light dark:bg-secondary-dark border border-tertiary-light dark:border-tertiary-dark">
        ...
        <div className="mt-4 space-y-4 text-text-secondary-light dark:text-text-secondary-dark px-1 ">
          ...
          <p className="leading-relaxed">📚 Cross-Domain Thinker,
            Possess a broad spectrum of general knowledge with strong reasoning skills across disciplines. Able to answer and explain the majority of questions across random topics due to continuous learning, curiosity, and critical thinking.</p>
